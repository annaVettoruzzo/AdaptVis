"""
Batch visualize attention rollout for all POPE samples.

Usage:
    python visualize_all_pope.py
    python visualize_all_pope.py --base-dir ./output/pope_base
...
def main():
    parser = argparse.ArgumentParser(description='Batch visualize attention rollout for POPE')
    parser.add_argument("--base-dir", default="./output/pope_base",
            help="Directory containing attention maps")
    parser.add_argument("--output-dir", default="./rollout_outputs/pope",
    ...
    if not base_dir.exists():
        print(f"❌ Error: {base_dir} not found. Run rollout_pope.py first.")
        return 1
